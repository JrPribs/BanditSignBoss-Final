            ...
            form.registration-form.form-horizontal.sp-form(method='post', role='form')
              ...
              .form-group.group-email(form-group='true')
                ...
                .col-sm-8
                  ...
                  input.form-control(placeholder='Email', name='email', value=value, required='true', type='email')

              .form-group.group-phone(form-group='true')
                label.col-sm-4 Phone Number
                .col-sm-8
                  - var value = form.data ?  form.data.phone : '';
                  input.form-control(placeholder='Phone Number', name='phone', value=value, required='true', type='tel')
